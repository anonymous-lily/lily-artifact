...
ref_previous="v2.9.14"
ref_current="v2.12.7"
prefix="libxml2__simple-release"

BENCHMARK_TARGETS=(
    "magma-harness.patch libxml2 $ref_previous $prefix-$ref_previous"
    "backdoor-v2.12.7.patch:magma-harness.patch libxml2 $ref_current $prefix-${ref_current}__backdoored"
    "backdoor-v2.12.7.patch:magma-harness.patch libxml2 $ref_current $prefix-${ref_current}__backdoored__coverage"
    "ground-truth-v2.12.7.patch:magma-harness.patch libxml2 $ref_current $prefix-${ref_current}__ground-truth"
)
