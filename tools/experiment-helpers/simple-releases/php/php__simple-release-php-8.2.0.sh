...
ref_previous="php-7.4.0"
ref_current="php-8.2.0"
prefix="php__simple-release"

BENCHMARK_TARGETS=(
    "harness-3204d7e0d1.patch php $ref_previous $prefix-$ref_previous"
    "backdoor.patch:harness-9b15537e9a.patch php $ref_current $prefix-${ref_current}__backdoored"
    "backdoor.patch:harness-9b15537e9a.patch php $ref_current $prefix-${ref_current}__backdoored__coverage"
    "ground-truth.patch:harness-9b15537e9a.patch php $ref_current $prefix-${ref_current}__ground-truth"
)
